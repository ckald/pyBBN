...
std::pair<std::vector<double>, std::vector<double>> integrand(
    double p0, const std::vector<double> &p1s, const std::vector<double> &p2s, int length,
    ...
    */
    ...
    std::vector<double> integrands_1(length, 0.), integrands_f(length, 0.);
