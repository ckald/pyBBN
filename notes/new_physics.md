...
<center><img src="pion_decay.png" width=50% /></center>
...
\begin{align}
    \Delta \mathcal{L}\_{\pi W} &= f_\pm |V_{ud}| (\partial_\mu \pi) {W^\dagger}^\mu + h.c.
    \\\\ \Delta \mathcal{L}\_{\pi Z} &= f_0 (\partial_\mu \pi^0) Z^\mu
\end{align}
