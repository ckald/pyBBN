...
def Gamma_pi_charged(mass, theta):
    xpi = 139.57 / mass
    xe = 0.511 / mass
    return ((1.166e-11 * theta * 130.2 * 0.974)**2 * mass**3
            * ((1 - xe**2)**2 - xpi**2 * (1 + xe**2)) * np.sqrt(1 + xe**4 + xpi**4 - 2 * xe**2 - 2 * xpi**2 - 2 * xe**2 * xpi**2)) / (16 * np.pi)
...
def Gamma_charged_rho(mass, theta):
    ...
    xe = 0.511 / mass
    Gamma = (
        (1.166e-11 * theta * 0.974 * 209)**2 * mass**3 * ((1 - xe**2)**2 + xrho**2 * (1 + xe**2) -2 * xrho**4)
        * np.sqrt(1 + xe**4 + xrho**4 - 2 * xe**2 - 2 * xrho**2 - 2 * xe**2 * xrho**2)
    ) / (16 * np.pi)
    return Gamma
